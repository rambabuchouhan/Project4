...
System.out.println(pstmt);
	 ...
	 * @throws DatabaseException
	 */
	public int delete(UserBean bean) throws ApplicationException {
		int i = 0;
		Connection conn = null;
	...
	public void update(UserBean bean) throws ApplicationException, DuplicateRecordException {
		...
		try {
			...
			PreparedStatement pstmt = conn.prepareStatement(
					...
					+ "ROLE_ID=?,UNSUCCESSFUL_LOGIN=?,GENDER=?,LAST_LOGIN=?,USER_LOCK=?,REGISTERED_IP=?,"
					+ "LAST_LOGIN_IP=?,CREATED_BY=?,MODIFIED_BY=?,CREATED_DATETIME=?,MODIFIED_DATETIME=? WHERE ID=?");
	...
	public UserBean authenticate(String login, String password) throws ApplicationException {
		...
		UserBean bean = null;
		Connection conn = null;
System.out.println("string buffer m qurey pass kravai ");
		try {
			conn = JDBCDataSource.getConnection();
			PreparedStatement pstmt = conn.prepareStatement(sql.toString());
	...
	public boolean changePassword(Long id, String oldPassword, String newPassword)
		...
		System.out.println("old password..." + beanExist.getPassword() + " password...." + oldPassword);
