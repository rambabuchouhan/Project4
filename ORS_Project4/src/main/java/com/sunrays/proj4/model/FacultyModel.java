...
System.out.println("\n COllege coll " + collegeBean.getName());
		...
		try {
			conn = JDBCDataSource.getConnection();
			pk = nextPK();
System.out.println(" ooooooooooooooooooo \n  values College "+bean.getCollegeName());
System.out.println(" 0000000000000000000 \n  values Course "+bean.getCourseName());
		...
		System.out.println("Add sucessfuly");
		return pk;
	}
	/**
	 * Delete Faculty 
