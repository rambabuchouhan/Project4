...
public class MyProfileCtl extends BaseCtl {
	...
	protected boolean validate(HttpServletRequest request) {
		...
		log.debug("MyProfi leCtl Method validate Started");
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (id > 0 || op != null) {
			...
			try {
				...
				System.out.println("model ki findpk mathad pk chli");
			...
			System.out.println("forword grtview");
		}
...
System.out.println("op save aaya bean ko bpopulate kiya and condition id>o userbean.set aal aatribute kr liya");
				}
				ServletUtility.setBean(bean, request);
