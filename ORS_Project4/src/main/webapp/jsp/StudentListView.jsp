...
<%@page import="org.w3c.dom.html.HTMLAnchorElement"%>
			...
			<table width="100%">
				...
				<tr>
					<td align="center"><label> First Name :</label> <input
						...
						&emsp; &emsp;&emsp;&emsp;<label>Email_Id:</label> <input
						type="text" name="email" placeholder="Enter LoginId"
						value="<%=ServletUtility.getParameter("email", request)%>">&emsp;&emsp;
						&emsp; <label>College Name :</label> <%=HTMLUtility.getList("collegeId", ServletUtility.getParameter("collegeId", request), li)%>
