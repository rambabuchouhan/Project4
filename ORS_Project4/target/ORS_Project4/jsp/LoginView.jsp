...
<body>
	<form action="<%=ORSView.LOGIN_CTL%>" method="post">
		...
		<centre> <input type="hidden" name="uri"
		...
		<table style="margin-left: 38%">
			...
			<tr width="100" height="50">
				...
				<td><input type="text" name="login" size=30
					...
					value="<%=DataUtility.getStringData(bean.getLogin())%>"> <!------- Populate Data at View  ------->
			...
			<tr>
				...
				<td colspan="2"><input type="submit" name="operation"
					size="15" value="<%=LoginCtl.OP_SIGN_IN%>"> &nbsp;
			...
			<tr>
				...
				<td colspan="2"><a style="text-decoration: none"
					href="<%=ORSView.FORGET_PASSWORD_CTL%>"><b><h3>Forget
								my password ?</b>
					</h3></a>&nbsp;</td>
			</tr>
		</table>
