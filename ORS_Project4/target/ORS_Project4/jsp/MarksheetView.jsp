		...
		<table style="margin-left: 36%">
			...
			<tr>
				...
				<input type="text" name="physics"
					...
					value="<%= request.getAttribute("pk")!=null || bean.getId()>0 ? DataUtility.getStringData(bean.getPhysics()) :
			...
			<tr>
				...
				<td><input type="text" name="chemistry" size="25"
					...
					value="<%=request.getAttribute("pk")!=null || bean.getId()>0 ? DataUtility.getStringData(bean.getChemistry()) :
			...
			<tr>
				...
				<td><input type="text" name="maths" size="25"
					...
					value="<%=request.getAttribute("pk")!=null || bean.getId()>0 ? DataUtility.getStringData(bean.getMaths()) :
